...
class YouTubeTools():
    ...
    def __init__(self, **kwargs):
        ...
        file (str) path: This argument identifies the location of the video file that you are uploading.
            The default uploadable file should be named out.mp4
        ...
        '''
        video_dir = kwargs.get('videoDir', 'dat')
    ...
    def set_args(self, videoname='out.mp4', **kwargs):
        '''
        videoname (str): name of video file to be uploaded. 
            The default value will be out.mp4
        '''
        filearg = kwargs.get('file', f'{self._video_directory}/{videoname}')
        ...
        if not os.path.exists(self.args.file):
            exit(f"Check file {self._video_directory}/out.mp4 exists")
